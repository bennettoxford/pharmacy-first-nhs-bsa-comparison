generate_validation_comparison_dataset <- function(df_bsa_validation, df_pf_consultations_total) {
  ...
  df_os_validation_total <-  df_os_consultation_from_id_validation %>%
  ...
  return(df_pf_consultation_validation_plot)
}
